            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        ...
                        <li class="list-inline-item">/ &nbsp; <a href="{{url('/kontak')}}">Kontak</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        ...
                        <h1>kotak Yang Dapat Di Hubungi</h1>
                        <p>JIka Ada Yang Ingin Di tanyakan/kepentingan mengenai Masjid Kubah Mas Silahkan Hunbungi Kami</p>
                    </div>
                </div>
                <div class="col-lg-10">
                    <div class="shadow rounded p-5 bg-white">
                        <div class="row">
                            <div class="col-12 mb-4">
                                <h4>Tinggal kan Pesan Untuk Kami</h4>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6 mt-5 mt-lg-0">
                                <div class="contact-info">
                                    <div class="block mt-0">
                                        <h4 class="h5">Jika Ada Pertanyaan?</h4>
                                        <div class="content">Dapat Menghubungi Kami Di Nomer Berikut
                                    ...
                                    <div class="block mt-4">
                                        ...
                                        <div class="content">Komplek Masjid Kubah Emas, Jl. Hajah Dian Al Mahri, Meruyung,  
                                            <br>Kec. Limo, Kota Depok,
                                            <br>Jawa Barat 16515</div>
                                    </div>
                                    <div class="block">
