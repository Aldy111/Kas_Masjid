		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mx-auto mb-2 mb-lg-0">
					...
					<li class="nav-item "> <a class="nav-link" href="how-it-works.html">Kegiatan</a>
					</li>
					...
					<li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Pages</a>
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li><a class="dropdown-item " href="blog.html">Kas Masuk</a>
							</li>
							<li><a class="dropdown-item " href="blog-details.html">Kas Keluar</a>
							</li>
							<li><a class="dropdown-item " href="service-details.html">Laporan Kas</a>
							</li>
						</ul>
					</li>
				</ul>
