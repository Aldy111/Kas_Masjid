	...
	<div class="container">
		<div class="row">
			<div class="col-8 mx-auto text-center">
				<h2 class="mb-3 text-capitalize">Detail Kegiatan</h2>
				<ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
					<li class="list-inline-item"><a href="index.html">Home</a>
					</li>
					<li class="list-inline-item">/ &nbsp; <a href="blog.html">Detail Kegiatan</a>
					</li>
				</ul>
			</div>
		</div>
...
<div class="section">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="mb-5">
          <h2 class="mb-4" style="line-height:1.5">{{$row->judul_kegiatan}}</h2>
          <span>{{\Carbon\Carbon::parse($row->tgl_kegiatan)->translatedFormat('l,d F Y')}}<span class="mx-2">/</span> </span>
          <p class="list-inline-item">Penanggung Jawab : <a href="#!" class="ml-1">{{$row->petugas->nama}} </a>
          </p>
        </div>
        ...
        <div class="content">
          <h4 id="heading-example">Keterangan</h4>
          <p>{{$row->ket}}</p>
          <hr>
        </div>
      </div>
