          ...
          <div class="rounded shadow bg-white p-5 tab-content" id="pills-tabContent">
                ...
                <div class="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                  <div class="image-block text-center">
                    <img loading="lazy" decoding="async"
                      src="{{url('images/payment-info.png')}}" alt="How Much Can I Recive?" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
            <div class="tab-pane fade " id="pills-how-much-does-it-costs" role="tabpanel"
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                  <div class="image-block text-center">
                    <img loading="lazy" decoding="async" src="{{url('images/illustration-2.png')}}" alt="How Much Does It Costs?" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
            <div class="tab-pane fade " id="pills-how-do-i-repay" role="tabpanel"
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                  <div class="image-block text-center">
                    <img loading="lazy" decoding="async" src="{{url('images/illustration-1.png')}}" alt="How Do I Repay?" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
