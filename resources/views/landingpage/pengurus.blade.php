	...
	<div class="container">
		<div class="row">
			<div class="col-8 mx-auto text-center">
				<h2 class="mb-3 text-capitalize">Kepengurusan</h2>
				<ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
					<li class="list-inline-item"><a href="{{ url('/home')}}">Home</a>
					</li>
					<li class="list-inline-item">/ &nbsp; <a href="{{url('/pengurus')}}">Pengurus</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="row justify-content-center">
			<div class="col-12">
				<div class="section-title text-center">
					<p class="text-primary text-uppercase fw-bold mb-3">Kepengurusan</p>
					<h2>Pengurus Masjid Kubah Mas</h2>
				</div>
			</div>
		</div>
				...
				<div class="card bg-transparent border-0 text-center">
					<div class="card-img">
						...
						<ul class="card-social list-inline">
							<li class="list-inline-item"><a class="facebook" title="Detail Petugas" href="{{ route('pengurus.show',$row->id) }}"><i class="fa fa-user"></i></a>
							</li>
						</ul>
					</div>
					<div class="card-body">
						<h3>{{ $row->nama }}</h3>
						<p>{{ $row->jabatan->nama_jabatan }}</p>
					</div>
				</div>
			</div>
        @endforeach
