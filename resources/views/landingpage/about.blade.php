		...
		<div class="row">
			<div class="col-8 mx-auto text-center">
				...
				<ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
					<li class="list-inline-item"><a href="{{ url('/home')}}">Home</a>
					</li>
					<li class="list-inline-item">/ &nbsp; <a href="{{url('/about')}}">Tentang</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="row justify-content-center align-items-center">
			<div class="col-lg-6">
				<div class="section-title">
					<p class="text-primary text-uppercase fw-bold mb-3">About Masjid Kubah Mas</p>
					<h2 class="h1 mb-4">Latar Belakang Dan <br> Sejarah Masjid Kubah Mas</h2>
					<div class="content pe-0 pe-lg-5">
						<p>Dian Djuriah Rais binti Muhammad Rais atau yang lebih dikenal sebagai Dian Al Mahri wafat pada Jumat (29/3/2019) pukul 02.15 WIB dini hari di Rumah Sakit Pondok Indah, Jakarta Selatan. Dian Al Mahir adalah pendiri sekaligus pemilik Masjid Kubah Emas. Sejarah pembangunan masjid megah yang didirikan di Depok, Jawa Barat, ini dimulai sejak 2001. Bersama suaminya, Maimun Al Rasyid, Dian Al Mahri membeli lahan di Kecamatan Limo, Depok, pada 1996, inilah yang nantinya menjadi tempat dibangunnya Masjid Kubah Emas. Dian Al Mahri adalah seorang pengusaha asal Banten yang memiliki beberapa sektor bisnis, termasuk tambang minyak bumi di Brunei Darussalam. Dikutip dari Suara Hidayatullah (2008), proses pembangunan Masjid Kubah Emas memakan waktu 7 tahun. Pengerjaan pembangunan masjid ini mulai dilakukan sejak 2001 dan diresmikan pada 31 Desember 2006, bertepatan dengan Hari Raya Idul Adha. Penggunaan pertama Masjid Kubah Emas adalah untuk melaksanakan Salat Ied tahun 1427 Hijriah saat itu. Bangunan Masjid Kubah Emas didirikan di atas tanah berukuran 8.000 meter persegi dengan luas total lahan 50 hektare dan dapat menampung sekitar 20.000 jamaah. Halamannya saja, yang berukuran 45 x 57 meter, bisa memuat 8.000 orang.</p>
						<i>Baca selengkapnya di artikel "Sejarah Masjid Kubah Emas & Wafatnya Sang Pendiri, Dian Al Mahri", <a href="https://tirto.id/dkui">https://tirto.id/dkui</a></i>
					</div>
				</div>
			</div>
			<div class="col-lg-6 mt-5 mt-lg-0">
				<img loading="lazy" decoding="async" src="{{url('images/banner/banner1.jpeg')}}" alt="" class="rounded w-100">
			</div>
		</div>
	</div>
</section>
