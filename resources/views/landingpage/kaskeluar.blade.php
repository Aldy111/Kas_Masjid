	...
	<div class="container">
		<div class="row">
			<div class="col-8 mx-auto text-center">
				<h2 class="mb-3 text-capitalize">Kas Keluar</h2>
				<ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
					<li class="list-inline-item"><a href="{{ url('/home')}}">Home</a>
					</li>
					<li class="list-inline-item">/ &nbsp; <a href="{{url('/kaskeluar')}}">Kas Keluar</a>
					</li>
				</ul>
			</div>
		</div>
...
<div class="section">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="content">
            <h2 style="text-align:center">Laporan Kas Keluar</h2>
          <hr>
          <h5 id="tables">Kas Keluar</h5>
