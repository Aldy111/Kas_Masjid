	...
	<div class="container">
		<div class="row">
			<div class="col-8 mx-auto text-center">
				<h2 class="mb-3 text-capitalize">Petugas Jumaat</h2>
				<ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
					<li class="list-inline-item"><a href="{{ url('/home')}}">Home</a>
					</li>
					<li class="list-inline-item">/ &nbsp; <a href="{{url('/petugasjumaat2')}}">Petugas Jumaat</a>
					</li>
				</ul>
			</div>
		</div>
...
<div class="section">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="content">
            <h2 style="text-align:center">Jadwal Petugas Jumaat</h2>
          <hr>
          <h5 id="tables">Jadwal</h5>
          <p>jadwal yang bertugas menjadi petugas jumaat.</p>
          <table>
            <thead>
              <tr>
                <th>No</th>
